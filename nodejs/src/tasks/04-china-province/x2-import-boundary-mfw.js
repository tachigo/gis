...
(async () => {
  ...
  const shpFilename = `${$.Utils.dataDir}/shapefile/china-province-boundary/boundary.shp`;
  const dbfFilename = `${$.Utils.dataDir}/shapefile/china-province-boundary/boundary.dbf`;
